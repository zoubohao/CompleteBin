...
if __name__ == "__main__":
    ...
    # output_folder = "/home/datasets/ZOUbohao/Proj3-DeepMetaBin/plant-align-contigs-2-ref-genome"
    # home_path = "/home/datasets/ZOUbohao/Proj3-DeepMetaBin/CAMI-Plant-contigs-bam"
    # query_path = "/home/datasets/ZOUbohao/Proj3-DeepMetaBin/marine_ref_genomes.fasta"
    ...
    #     cmd = f"minimap2 {query_path} {cur_contig_path} -o {cur_output_path} -t 32"
    #     print(cmd)
    #     os.system(cmd)
