...
if __name__ == "__main__":
    ...
    out_folder = "/home/datasets/ZOUbohao/Proj3-DeepMetaBin/CONCOCT-marine-multi-sample"
    ...
    for i in range(10):
        ...
        bin_concoct(cur_contig_path, bam_list, cur_bin_output_folder, depth_file_path, 86, multi_sample=True)
