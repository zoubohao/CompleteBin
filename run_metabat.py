...
def cal_depth(sorted_bam_path, out_depth_file_path):
    cmd = f"jgi_summarize_bam_contig_depths --outputDepth {out_depth_file_path} {sorted_bam_path}"
    os.system(cmd)
...
if __name__ == "__main__":
    ...
    out_folder = "/home/datasets/ZOUbohao/Proj3-DeepMetaBin/MetaBAT2-marine-multi-sample"
    ...
    for i in range(1, 10):
        ...
        bin_metabat2(cur_contig_path, bam_list, cur_bin_output_folder, depth_file_path, 86, multi_sample=True)
